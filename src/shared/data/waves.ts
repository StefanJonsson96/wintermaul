...
const W: WaveSpec[] = [
  ...
  /* 4 */ { name: 'Tundra Boar', shape: 'boar', colors: ['#8a6a55', '#4d3a2e', '#f2e6d0'], armorType: 'heavy', hint: 'Thick hides: Impact and Magic work best.', hpMul: 1.35 },
  ...
  /* 6 */ { name: 'Frost Troll', shape: 'troll', colors: ['#7fb3a8', '#3c6b61', '#e8f0ec'], armorType: 'medium', hint: 'Trolls regenerate. Burst them down.', regen: 0.02 },
  ...
  /* 8 */ { name: 'Glacier Crab', shape: 'crab', colors: ['#7ab0d8', '#2f5f8a', '#e6f6ff'], armorType: 'fortified', hint: 'FORTIFIED shells. Bring Impact or Pure damage.', armorAdd: 3, speedMul: 0.9 },
  ...
  /* 14 */ { name: 'Frozen Revenant', shape: 'wraith', colors: ['#a9e8ff', '#3f7fa8', '#e0fbff'], armorType: 'spirit', hint: 'Restless dead that knit themselves back together.', regen: 0.015 },
  /* 15 */ { name: 'Snow Golem', shape: 'golem', colors: ['#eef4fa', '#9fb8d0', '#5fe3ff'], armorType: 'heavy', hint: 'Splits into two snowlings when destroyed.', split: true, hpMul: 0.9 },
  ...
  /* 21 */ { name: 'Crystal Beetle', shape: 'beetle', colors: ['#7ff3ff', '#2f7a8a', '#ff7fd1'], armorType: 'fortified', hint: 'Crystal carapaces that split into shards.', split: true, armorAdd: 3, hpMul: 0.9 },
  ...
  /* 28 */ { name: 'Glacial Behemoth', shape: 'boar', colors: ['#8fb8d8', '#3a5a7a', '#e6f6ff'], armorType: 'fortified', hint: 'Regenerating fortified monsters.', regen: 0.012, hpMul: 1.1, size: 0.6 },
  /* 29 */ { name: 'Hydra Spawn', shape: 'spider', colors: ['#5fa88a', '#2a4a3a', '#b8ff80'], armorType: 'heavy', hint: 'Cut one down and two more crawl out.', split: true },
  ...
  /* 32 */ { name: 'Ice Titan', shape: 'golem', colors: ['#d0ecff', '#4f7fa8', '#7ff3ff'], armorType: 'fortified', hint: 'Enormous fortified titans.', hpMul: 1.2, speedMul: 0.85, size: 0.62, armorAdd: 3 },
  ...
  /* 34 */ { name: 'Frost Hydra', shape: 'dragon', colors: ['#6fc8b8', '#2a5a50', '#e6fff8'], armorType: 'heavy', hint: 'Heads regrow: splits when slain.', split: true, hpMul: 0.95 },
  ...
  /* 37 */ { name: 'Wendigo', shape: 'troll', colors: ['#d8d0c0', '#5a4a3a', '#ff5a4f'], armorType: 'light', hint: 'Starving, fast, regenerating.', speedMul: 1.35, regen: 0.015, hpMul: 0.85 },
  ...
  /* 40 */ { name: 'The Winter Tyrant', shape: 'boss', colors: ['#d8f0ff', '#1f3f7a', '#7ff3ff'], armorType: 'heavy', title: 'FINAL BOSS', hint: 'The Winter Tyrant himself. If he escapes, the north falls (25 lives).', boss: true, immune: true, regen: 0.002, leak: 25 },
];
...
W.forEach((spec, i) => {
  ...
  CREEPS[id] = {
    ...
    regen: spec.regen,
    shield: spec.shield,
    heal: spec.heal ? { every: 3, radius: 2.5, pct: spec.boss ? 0.04 : 0.06 } : undefined,
    size: sizeFor(spec),
    shape: spec.shape,
    colors: spec.colors,
  };
